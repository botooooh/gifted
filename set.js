...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~LmIRxZbb#l8Ae0Aq5yAPqYHMl1zJMJ405cQd6aNB_jBeeYTxSdc0", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "2250151191073, 2250747822254", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "2250151191073", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "𝕴𝖛𝖆𝖓×͜×👑", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "𝕴𝖛𝖆𝖓×͜×👑", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "moi mes stickers sont cool💜", // Added // Input Yours custom...
...
BOT_PIC: process.env.BOT_PIC || "https://files.catbox.moe/x9tx0s.jpeg", // You can Replace with yours...
...
TIME_ZONE: process.env.TIME_ZONE || "Africa/Ivoiry Cost", // Enter yours else leave blank if not sure
};
